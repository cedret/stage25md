...
installssprod ()
{
    ...
    sudo openssl req -x509 -nodes -days 365 -newkey rsa:2048 -keyout /etc/ssl/prod/prod.key -out /etc/ssl/prod/prod.crt -subj "/C=FR/ST=IDF/L=IVRY/O=auto/CN=192.168.80.139"
